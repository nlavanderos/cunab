...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { id: @curso.id, nombre: @curso.nombre, periodo: @curso.periodo } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { id: @curso.id, nombre: @curso.nombre, periodo: @curso.periodo } }
