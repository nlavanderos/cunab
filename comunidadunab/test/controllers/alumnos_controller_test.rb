...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { apellido: @alumno.apellido, email: @alumno.email, id: @alumno.id, nombre: @alumno.nombre, tipo: @alumno.tipo } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { apellido: @alumno.apellido, email: @alumno.email, id: @alumno.id, nombre: @alumno.nombre, tipo: @alumno.tipo } }
